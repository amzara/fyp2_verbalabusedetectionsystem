        ...
        <View style={{flex:1,backgroundColor:Colors.white}} >
            ...
            <View style={{flex:2,backgroundColor:'#fff'}} >
                ...
                <View style={{flex:1,flexDirection:'column',justifyContent:'flex-start',alignItems:'center',backgroundColor:'#fff'}} >
                    <Text style={{fontFamily:'OpenSans-Bold',color:Colors.black,fontSize:30}} >BeNice!</Text>
                    <Text style={{maxWidth:'50%', fontFamily:'OpenSans-Medium',color:"#999",fontSize:14, textAlign:'center',paddingTop:10}} >A system to detect instances of verbal abuse.</Text>
                </View>   
                ...
                <View style={{flex:1,flexDirection:'column',justifyContent:'flex-end',alignItems:'center'}} >
                    ...
                    <Buttons btn_text={"Get Started"} on_press={()=>navigation.navigate("Login2")} />
